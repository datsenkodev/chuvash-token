...
export default function komyssyy_82_270954_() {
  ...
  return (
    ...
    <div  class="bg-[rgb(0,0,0)] border-[0.87px] flex flex-col flex-nowrap frame gap-[8.72px] h-[812.79px] items-CENTER justify-between overflow-clip pl-[20.00px] pr-[20.00px] w-[375.00px] z-[4]" >
      <div  class="absolute bg-[rgba(0,0,0,0.000000)] border-[0.87px] frame h-[1110.76px] w-[825.58px] z-[2]" >
        ...
        <div  class="bg-[rgba(0,0,0,0.000000)] border-[0.32px] group h-[1110.76px] w-[825.58px] z-[4]" >
        ...
        <svg  class="aspect-[1.00] border-[0.87px] h-[375.00px] object-contain rectangle w-[375.00px] z-[5]"  strokeWidth="0.87px" xmlns="http://www.w3.org/2000/svg"/>
      </div>
