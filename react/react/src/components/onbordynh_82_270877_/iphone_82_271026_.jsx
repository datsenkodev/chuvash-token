...
export default function iphone_82_271026_() {

  return (

    <div  class="bg-[rgb(17,17,17)] border-[0.87px] flex flex-col flex-nowrap frame gap-[8.72px] h-[812.79px] items-CENTER justify-between overflow-clip pl-[16.00px] pr-[16.00px] w-[375.00px] z-[6]" >
      ...
      <div  class="bg-[rgba(0,0,0,0.000000)] border-[0.87px] flex flex-col flex-nowrap frame gap-[24.00px] h-[22.00px] w-[347.09px]" >
        <span  class="flex" />
      </div>

      <ellipse  class="flex"  strokeWidth="1.00px" xmlns="http://www.w3.org/2000/svg"/>

      <div  class="bg-[rgba(0,0,0,0.000000)] border-[1.00px] flex flex-col flex-nowrap frame gap-[16.00px] h-[259.00px] items-CENTER w-[343.00px]" >
        <div  class="bg-[rgba(20,19,18,0.010000)] border-[1.00px] flex flex-col flex-nowrap frame gap-[12.00px] h-[160.00px] overflow-clip pb-[16.00px] pl-[16.00px] pr-[16.00px] pt-[16.00px] rounded-[16.00px] w-[343.00px]" >
        ...
        <div  class="bg-[rgba(0,0,0,0.000000)] border-[1.00px] flex flex-nowrap flex-row frame gap-[16.00px] h-[22.00px] items-CENTER w-[180.00px]" >
          <svg  class="border-[1.00px] flex grow-1.0 h-[0.00px] line w-[58.00px]"  stroke="rgb(255,255,255)" strokeLinecap="round" strokeWidth="1.00px" xmlns="http://www.w3.org/2000/svg">
            <div />
          </svg>
      ...
      <div  class="bg-[rgba(0,0,0,0.000000)] border-[1.00px] flex flex-col flex-nowrap frame gap-[10.00px] h-[114.00px] items-CENTER justify-end min-h-[114.00px] w-[375.00px]" >
        <div  class="bg-[rgba(0,0,0,0.000000)] border-[1.00px] flex flex-col flex-nowrap frame h-[108.00px] w-[375.00px]" >
          <div  class="bg-[rgb(19,18,17)] border-[0.87px 0.00px 0.00px 0.00px] flex flex-col flex-nowrap frame gap-[8.72px] h-[74.00px] overflow-clip pb-[12.00px] pl-[12.00px] pr-[12.00px] pt-[12.00px] w-[375.00px]" >
            <button  class="bg-[rgb(255,255,255)] border-[1.00px] border-[rgb(71,71,71)] border-solid cursor-pointer flex flex-nowrap flex-row gap-[10.00px] h-[50.00px] instance items-CENTER justify-between opacity-50 pb-[8.00px] pl-[20.00px] pr-[20.00px] pt-[8.00px] rounded-[423243.00px] self-stretch w-[351.00px]" >
              <span  class="flex" />
