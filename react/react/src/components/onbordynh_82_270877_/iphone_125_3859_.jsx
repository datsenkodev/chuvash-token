...
export default function iphone_125_3859_() {

  return (

    <div  class="bg-[rgb(17,17,17)] border-[0.87px] flex flex-col flex-nowrap frame gap-[16.00px] h-[812.79px] items-CENTER overflow-clip pl-[16.00px] pr-[16.00px] pt-[1.00px] w-[375.00px] z-[9]" >
