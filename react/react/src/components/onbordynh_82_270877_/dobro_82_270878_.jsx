...
export default function dobro_82_270878_() {
  ...
  return (
    ...
    <div  class="bg-[rgb(0,0,0)] border-[0.87px] flex flex-col flex-nowrap frame gap-[8.72px] h-[812.79px] items-CENTER justify-between overflow-clip pl-[20.00px] pr-[20.00px] w-[375.00px] z-[2]" >
      <div  class="absolute bg-[rgba(0,0,0,0.000000)] border-[0.87px] frame h-[1110.76px] w-[825.58px] z-[2]" >
        ...
        <svg  class="border-[0.78px] h-[375.00px] left-0 rectangle top-0 w-[375.00px] z-[5]"  strokeWidth="0.78px" xmlns="http://www.w3.org/2000/svg"/>
      </div>
      ...
      <div  class="bg-[rgba(0,0,0,0.000000)] border-[1.00px] flex flex-col flex-nowrap frame gap-[24.00px] h-[235.91px] items-CENTER self-stretch w-[335.00px]" >
        ...
        <div  class="bg-[rgba(0,0,0,0.000000)] border-[0.87px] flex flex-col flex-nowrap frame gap-[27.91px] h-[121.91px] items-CENTER self-stretch w-[335.00px]" >
          <div  class="bg-[rgba(0,0,0,0.000000)] border-[0.87px] flex flex-nowrap flex-row frame gap-[6.98px] h-[0.00px] self-stretch w-[335.00px]" >
            <svg  class="border-[1.74px] flex grow-1.0 h-[0.00px] vector w-[78.52px]"  stroke="rgb(255,255,255)" strokeLinecap="round" strokeWidth="1.74px" xmlns="http://www.w3.org/2000/svg">
              <div />
            </svg>

            <svg  class="border-[1.74px] flex grow-1.0 h-[0.00px] vector w-[78.52px]"  stroke="rgb(153,153,153)" strokeLinecap="round" strokeWidth="1.74px" xmlns="http://www.w3.org/2000/svg">
              <div />
            </svg>
          ...
          <div  class="bg-[rgba(0,0,0,0.000000)] border-[0.87px] flex flex-col flex-nowrap frame gap-[13.95px] h-[94.00px] self-stretch w-[335.00px]" >
            <span  class="flex" />
          </div>
        </div>
      </div>

      <div  class="bg-[rgba(0,0,0,0.000000)] border-[1.00px] flex flex-col flex-nowrap frame h-[158.95px] items-CENTER self-stretch w-[335.00px]" >
        <div  class="bg-[rgba(0,0,0,0.000000)] border-[0.87px] flex flex-col flex-nowrap frame gap-[13.95px] h-[124.95px] self-stretch w-[335.00px]" >
          <span  class="flex" />

          <div  class="bg-[rgba(0,0,0,0.000000)] border-[0.87px] flex flex-nowrap flex-row frame gap-[6.98px] h-[45.00px] self-stretch w-[335.00px]" >
            <button  class="bg-[rgb(255,255,255)] border-[1.00px] border-[rgb(71,71,71)] border-solid cursor-pointer flex flex-nowrap flex-row gap-[10.00px] grow-1.0 h-[45.00px] instance items-CENTER justify-between pb-[8.00px] pl-[24.00px] pr-[24.00px] pt-[8.00px] rounded-[423243.00px] w-[335.00px]" >
              <span  class="flex" />
