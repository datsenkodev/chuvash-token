...
export default function ankety_126_7092_() {

  return (

    <div  class="absolute bg-[rgba(0,0,0,0.000000)] border-[1.00px] border-[rgb(138,56,245)] border-solid component_set h-[746.00px] left-[100.00px] overflow-clip rounded-[5.00px] top-[159.00px] w-[387.09px] z-10 z-[29]" >
      <component  class="bg-[rgba(71,71,71,0.300000)] border-[2.00px] component flex flex-col gap-[16.00px] h-[230.00px] h-fit left-[20.00px] m-[0 auto auto 0] p-[16.00px] property_126_7091_ relative rounded-[16.00px] top-[20.00px] w-[347.09px]" >
        <div  class="absolute bg-[rgba(0,0,0,0.000000)] border-[1.00px] flex flex-row frame gap-[8.00px] h-[38.00px] h-fit items-CENTER left-[16.00px] top-[16.00px] w-[137.00px] w-fit z-[2]" >
          <div  class="absolute bg-[rgba(0,0,0,0.000000)] border-[1.00px] flex flex-row frame gap-[8.00px] h-[38.00px] h-fit left-[0.00px] top-[0.00px] w-[137.00px] w-fit z-[2]" >
            <button  class="absolute bg-[rgb(255,255,255)] border-[1.00px] border-[rgb(71,71,71)] border-solid cursor-pointer flex flex-row frame gap-[4.00px] h-[38.00px] items-CENTER left-[0.00px] p-[8.00px 16.00px] rounded-[39.00px] top-[0.00px] w-[58.00px] w-fit z-[2]" >
              <span />
            ...
            <button  class="absolute bg-[rgba(71,71,71,0.350000)] border-[1.00px] border-[rgb(71,71,71)] border-solid cursor-pointer flex flex-row frame gap-[8.00px] h-[38.00px] items-CENTER left-[66.00px] p-[8.00px 16.00px] rounded-[39.00px] top-[0.00px] w-[71.00px] w-fit z-[3]" >
              <span />
        ...
        <div  class="absolute bg-[rgba(0,0,0,0.000000)] border-[2.50px] flex flex-row frame gap-[10.00px] gap-[normal] h-[38.00px] items-CENTER justify-between left-[16.00px] rounded-[22.00px] self-stretch top-[176.00px] w-[315.09px] w-full z-[6]" >
          <div  class="absolute bg-[rgba(0,0,0,0.000000)] border-[1.00px] flex flex-row frame gap-[8.00px] h-[37.00px] h-fit items-CENTER left-[0.00px] top-[0.50px] w-[134.00px] w-fit z-[2]" >
          ...
          <div  class="absolute bg-[rgba(0,0,0,0.000000)] border-[1.00px] flex flex-col frame h-[34.00px] h-fit items-end justify-CENTER left-[157.55px] top-[2.00px] w-[72.00px] w-fit z-[4]" >
            <span />
      ...
      <component  class="bg-[rgba(71,71,71,0.300000)] border-[2.00px] component flex flex-col gap-[16.00px] h-[230.00px] h-fit left-[20.00px] m-[0 auto auto 0] p-[16.00px] property_126_7090_ relative rounded-[16.00px] top-[258.00px] w-[347.09px]" >
      ...
      <component  class="bg-[rgba(71,71,71,0.300000)] border-[2.00px] component flex flex-col gap-[16.00px] h-[230.00px] h-fit left-[20.00px] m-[0 auto auto 0] p-[16.00px] property_126_7089_ relative rounded-[16.00px] top-[496.00px] w-[347.09px]" >
        <div  class="absolute bg-[rgba(0,0,0,0.000000)] border-[1.00px] flex flex-row frame gap-[8.00px] h-[38.00px] h-fit items-CENTER left-[16.00px] top-[16.00px] w-[117.00px] w-fit z-[2]" >
          <div  class="absolute bg-[rgba(0,0,0,0.000000)] border-[1.00px] flex flex-row frame gap-[8.00px] h-[38.00px] h-fit left-[0.00px] top-[0.00px] w-[117.00px] w-fit z-[2]" >
            <button  class="absolute bg-[rgba(71,71,71,0.350000)] border-[1.00px] border-[rgb(71,71,71)] border-solid cursor-pointer flex flex-row frame gap-[8.00px] h-[38.00px] items-CENTER left-[0.00px] p-[8.00px 16.00px] rounded-[39.00px] top-[0.00px] w-[117.00px] w-fit z-[2]" >
