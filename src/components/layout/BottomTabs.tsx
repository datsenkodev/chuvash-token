...
const ReferralIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    />
    <path
      d="M8.5 6.5H7C3.97 6.5 1.5 8.97 1.5 12C1.5 15.02 3.97 17.5 7 17.5H8.5"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path d="M7.5 12H15.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
)
  ...
  return (
    <nav className="bottom-tabs">
      <NavLink to="/" className={({ isActive }) => `tab-item${isActive ? ' active' : ''}`} end>
        <img src="/images/rank-1.svg" alt="" className="size-6" />
        <span>Home</span>
      </NavLink>
      <NavLink to="/referral" className={({ isActive }) => `tab-item${isActive ? ' active' : ''}`}>
        <ReferralIcon />
        <span>Referral</span>
      </NavLink>
